...
p0=300;n0=375;
SP500_return=SP500_return(1:n0,:);
SP500_return_mean=ones(n0,1)*sum(SP500_return)/n0;
SP500_return_cov=((SP500_return-SP500_return_mean)'*(SP500_return-SP500_return_mean))/n0;

rep1=1000;rep2=1000;sigma0=1;y=p0/n0;
...
save('return_combine');
mean_combine=sum(return_combine')/rep1;
stand_combine=sqrt(sum((return_combine').^2)/rep1-(mean_combine).^2);
save('mean_combine');
save('stand_combine');