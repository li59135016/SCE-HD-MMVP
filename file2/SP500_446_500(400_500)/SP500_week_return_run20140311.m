...
p0=400;n0=500;rep1=100;rep2=100;sigma0=1;y=p0/n0;
V_sel=variable_select(1:rep1,1:p0);

Eigen_S_star=zeros(rep1,rep2);
Eigen_cor=zeros(p0,rep1);
Eigen_S=zeros(p0,rep1);
for i=1:rep1
    ...
    [Eigenvector_S,Eigenvalues_S]=eig(S);Eigen_S(:,i)=max(Eigenvalues_S);
    inv_S=Eigenvector_S*inv(Eigenvalues_S)*(Eigenvector_S)';
    [Eigenvector_cor,Eigenvalues_cor]=eig(Cor);Eigen_cor(:,i)=max(Eigenvalues_cor);
